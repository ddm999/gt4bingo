...
// Tags
var Manufacturer = {name: "Manufacturer", max: [15,12,10,8,4,2], line: true},
...
Courses_Orig.forEach(element => {
	...
	if (element.reverse == true)
	{
		...
		if (list < 5)
		{
			bingoList_rando_v1[list+1].push({
